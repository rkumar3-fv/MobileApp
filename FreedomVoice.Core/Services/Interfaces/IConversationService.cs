...
namespace FreedomVoice.Core.Services.Interfaces
{
    public interface IConversationService
    {
        ...
        /// <returns></returns>
        Task<ConversationListResponse> GetList(string systemPhoneNumber, DateTime current, int count = 10, int page = 1);
        ...
        /// <param name="page"></param>
        /// <returns></returns>
        Task<ConversationListResponse> Search(string systemPhoneNumber, string query, string[] foundInNumbers, DateTime current, int count = 10, int page = 1);
        ...
        /// <returns></returns>
        Task<ConversationResponse> Get(string systemPhoneNumber, string toPhone);
    }
}
