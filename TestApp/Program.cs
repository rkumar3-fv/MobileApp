...
namespace TestApp
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ApiHelper.OnDownloadStatus += ApiHelper_OnDownloadStatus;

            var cancel = new CancellationTokenSource();
            var login = ApiHelper.Login(_login, _passwd).GetAwaiter().GetResult();
            Console.WriteLine(Process.GetCurrentProcess().WorkingSet64);
            cancel.Cancel();
            Stopwatch sw1 = new Stopwatch();
            sw1.Start();
            var b = ApiHelper.GetMedia("7607124648", 80, "New", "I161954426", MediaType.Pdf, cancel.Token)
                .Result;
            sw1.Stop();
            ...
            sw2.Start();
            var a =ApiHelper.GetMedia("7607124648", 80, "New", "I161578702", MediaType.Pdf, cancel.Token)
               .Result;
            sw2.Stop();
        ...
        private static void ApiHelper_OnDownloadStatus(string messageId, DownloadStatusArgs args)
        {
            var a = 1;
        }
    }
